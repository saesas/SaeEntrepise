 ...
 */
@Stateless
public class ClaseLibretaMilitarFacade extends AbstractFacade<ClaseLibretaMilitar> implements ClaseLibretaMilitarFacadeLocal {
    ...
    public ClaseLibretaMilitarFacade() {
