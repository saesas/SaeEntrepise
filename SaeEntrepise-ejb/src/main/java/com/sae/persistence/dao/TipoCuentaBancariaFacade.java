 ...
 */
@Stateless
public class TipoCuentaBancariaFacade extends AbstractFacade<TipoCuentaBancaria> implements TipoCuentaBancariaFacadeLocal {
    ...
    public TipoCuentaBancariaFacade() {
