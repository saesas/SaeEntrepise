 ...
 */
@Entity
@Table(name = "recurso", catalog = "bdsae", schema = "juridico")
@XmlRootElement
@NamedQueries({
    ...
    @NamedQuery(name = "Recurso.findByFechaRegistro", query = "SELECT r FROM Recurso r WHERE r.fechaRegistro = :fechaRegistro")})
public class Recurso implements Serializable {
    ...
    public String toString() {
        return "com.sae.persistence.domain.Recurso[ id=" + id + " ]";
    }
