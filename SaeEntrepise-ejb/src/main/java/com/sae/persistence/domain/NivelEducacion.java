 ...
 */
@Entity
@Table(name = "nivel_educacion", catalog = "bdsae", schema = "talento_humano")
@XmlRootElement
@NamedQueries({
    ...
    @NamedQuery(name = "NivelEducacion.findByNombre", query = "SELECT n FROM NivelEducacion n WHERE n.nombre = :nombre"),
    @NamedQuery(name = "NivelEducacion.findByEstado", query = "SELECT n FROM NivelEducacion n WHERE n.estado = :estado"),
    @NamedQuery(name = "NivelEducacion.findByFechaRegistro", query = "SELECT n FROM NivelEducacion n WHERE n.fechaRegistro = :fechaRegistro"),
    @NamedQuery(name = "NivelEducacion.findByIdUsuario", query = "SELECT n FROM NivelEducacion n WHERE n.idUsuario = :idUsuario")})
public class NivelEducacion implements Serializable {
    ...
    @OneToMany(mappedBy = "idNivelEducacion")
    ...
    public String toString() {
        return "com.sae.persistence.domain.NivelEducacion[ id=" + id + " ]";
    }
