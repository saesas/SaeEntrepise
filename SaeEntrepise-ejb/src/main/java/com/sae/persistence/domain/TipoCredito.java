 ...
 */
@Entity
@Table(name = "tipo_credito", catalog = "bdsae", schema = "tesoreria")
@XmlRootElement
@NamedQueries({
    ...
    @NamedQuery(name = "TipoCredito.findByEstado", query = "SELECT t FROM TipoCredito t WHERE t.estado = :estado"),
...
public class TipoCredito implements Serializable {
    ...
    public String toString() {
        return "com.sae.persistence.domain.TipoCredito[ id=" + id + " ]";
    }
