 ...
 */
@Entity
@Table(name = "configuracion", catalog = "bdsae", schema = "public")
@XmlRootElement
@NamedQueries({
    ...
    @NamedQuery(name = "Configuracion.findByFechaRegistro", query = "SELECT c FROM Configuracion c WHERE c.fechaRegistro = :fechaRegistro"),
...
public class Configuracion implements Serializable {
    ...
    public String toString() {
        return "com.sae.persistence.domain.Configuracion[ id=" + id + " ]";
    }
