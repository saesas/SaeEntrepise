 ...
 */
@Entity
@Table(name = "profesion", catalog = "bdsae", schema = "public")
@XmlRootElement
@NamedQueries({
    ...
    @NamedQuery(name = "Profesion.findByFechaRegistro", query = "SELECT p FROM Profesion p WHERE p.fechaRegistro = :fechaRegistro"),
    @NamedQuery(name = "Profesion.findByIdUsuario", query = "SELECT p FROM Profesion p WHERE p.idUsuario = :idUsuario")})
public class Profesion implements Serializable {
    ...
    public String toString() {
        return "com.sae.persistence.domain.Profesion[ id=" + id + " ]";
    }
