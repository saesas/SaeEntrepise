 ...
 */
@Entity
@Table(name = "tipo_documento", catalog = "bdsae", schema = "public")
@XmlRootElement
@NamedQueries({
    ...
    @NamedQuery(name = "TipoDocumento.findByIdUsuario", query = "SELECT t FROM TipoDocumento t WHERE t.idUsuario = :idUsuario")})
public class TipoDocumento implements Serializable {
    ...
    public String toString() {
        return "com.sae.persistence.domain.TipoDocumento[ id=" + id + " ]";
    }
